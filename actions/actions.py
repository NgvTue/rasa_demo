...
class ActionConceptHandle(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        return [SlotSet("type_slot","concept")]
...
class ActionReason(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        return [SlotSet("type_slot","reason")]
...
class ActionSympton(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message("bạn muốn hỏi về bệnh nào nhỉ ?", buttons=button)
        return [SlotSet("type_slot","symptom")]
...
class ActionPrevent(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message("bạn muốn hỏi về bệnh nào nhỉ ?", buttons=button)
        # dispatcher.utter_message("bạn muốn hỏi về bệnh nào nhỉ ?")
        return [SlotSet("type_slot","prevent")]
...
class ActionTreatment(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message("bạn muốn hỏi về bệnh nào nhỉ ?", buttons=button)
        # dispatcher.utter_message("bạn muốn hỏi về bệnh nào nhỉ ?")
        return [SlotSet("type_slot","treatment")]
